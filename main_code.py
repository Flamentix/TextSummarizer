        ...
        with open(args[1], 'r') as f:
            ...
            with open('source/adjs.txt', 'r') as a:
                ...
                if boolean == True:
                    ...
                    print("A fatal error has occured. Please report to Flamentix's Github.")
...
To find out more information regarding version history, visit the project at:
https://github.com/Flamentix/TextSummarizer
        ''')
